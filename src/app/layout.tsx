...
export const metadata: Metadata = {
  ...
  description: "Create stunning, compliant retail media ads in minutes with AI-powered design assistance. Built for Fynd Hiring Challenge 2026.",
  keywords: ["retail media", "ad creation", "AI", "Fynd", "marketing", "compliance"],
  authors: [{ name: "Jaykumar Girase" }],
  openGraph: {
    title: "RetailSync AI",

              ...
              <ScrollReveal delay={380} duration={800} distance={15}>
                <div className="pt-8 border-t border-gray-100">
                  ...
                  <div className="flex flex-wrap items-center justify-center gap-x-10 gap-y-4 opacity-50 grayscale hover:opacity-70 hover:grayscale-0 transition-all duration-500">
                    ...
                    <span className="font-poppins text-xl font-semibold text-gray-400">Fynd</span>
                    <span className="font-poppins text-lg font-semibold text-gray-400">Myntra</span>
                    <span className="font-poppins text-xl font-semibold text-gray-400">Amazon</span>
                    <span className="font-poppins text-lg font-semibold text-gray-400">Flipkart</span>
                    <span className="font-poppins text-xl font-semibold text-gray-400">Ajio</span>
                  </div>
                </div>
              </ScrollReveal>
            </div>
              ...
              <div className="space-y-8 lg:space-y-0">
                {[
                  ...
                  },
                  {
                    step: '03',
                    title: 'Export & Deploy',
                    description: 'One-click export for Fynd, Amazon, Myntra, or any platform. Multiple formats, instant delivery.',
                    color: '#F97316',
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
              {[
                ...
                },
                {
                  ...
                  description: 'Auto-validates against Fynd brand guidelines as you design.',
                  tag: 'Brand Engine',
                  number: '04',
            ...
            <div className="grid grid-cols-12 gap-4">
              ...
              <ScrollReveal delay={200} duration={1000} distance={40} className="col-span-12 sm:col-span-6 lg:col-span-4">
                <div className="h-full bg-gradient-to-br from-emerald-50/80 to-teal-50/80 backdrop-blur-xl rounded-3xl p-6 border border-emerald-200/60 shadow-[0_8px_40px_rgba(0,0,0,0.04)] hover:shadow-[0_20px_60px_rgba(16,185,129,0.1)] transition-all duration-500 group hover:-translate-y-1">
                  ...
                  <p className="font-poppins text-gray-600 text-sm leading-relaxed">Real-time Fynd brand guideline validation</p>
                </div>
              </ScrollReveal>
          ...
          <div className="max-w-5xl mx-auto relative">
            <ScrollReveal duration={1200} distance={40}>
              <div className="text-center mb-24">
                {/* Minimal overline */}
                <p className="font-poppins text-[11px] font-medium text-gray-400 tracking-[0.3em] uppercase mb-6">Created For</p>
                ...
                <h2 className="font-poppins text-5xl md:text-6xl lg:text-7xl font-semibold text-gray-900 tracking-[-0.03em] leading-[1]">
                  Fynd <span className="italic font-normal text-gray-400">Hiring Challenge</span>
                </h2>
              </div>
            </ScrollReveal>

            <div className="flex justify-center">
              <ScrollReveal delay={100} duration={1000} distance={30}>
                <div className="group text-center">
                  {/* Large Photo with thin border */}
                  <div className="relative mb-6">
                    <div className="relative w-48 h-48 mx-auto rounded-full overflow-hidden border border-gray-200 group-hover:border-gray-300 transition-all duration-500">
                      <img 
                        src="/team/jaykumar.jpeg" 
                        alt="Jaykumar Girase" 
                  ...
                  <h3 className="font-poppins text-xl text-gray-900 mb-2 tracking-[-0.01em]">
                    <span className="font-semibold">Jaykumar</span>{' '}
                    <span className="font-normal italic text-gray-500">Girase</span>
                  </h3>
                  
                  {/* Tagline */}
                  <p className="font-poppins text-[14px] text-gray-500 tracking-wide">Full Stack Developer</p>
                </div>
              </ScrollReveal>
            </div>
          </div>
          ...
          <div className="relative max-w-6xl mx-auto px-6">
            ...
            <div className="py-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-6">
              <p className="font-poppins text-sm text-gray-500">
                © 2026 RetailSync AI. Made for Fynd Hiring Challenge.
              </p>
              <div className="flex items-center gap-4">
                <Link href="https://github.com/JaykumarGirase11" target="_blank" className="w-10 h-10 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 flex items-center justify-center text-gray-400 hover:text-white hover:bg-white/10 transition-all duration-300">
                ...
                <Link href="https://www.linkedin.com/in/jaykumar-girase-874210272/" target="_blank" className="w-10 h-10 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 flex items-center justify-center text-gray-400 hover:text-white hover:bg-white/10 transition-all duration-300">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">

...
const BRAND_LOGOS = {
  ...
  retail: [
    { id: 'fynd', name: 'Fynd', svg: `<svg viewBox="0 0 100 40"><rect width="100" height="40" rx="4" fill="#41E0D0"/><text x="50" y="28" text-anchor="middle" fill="white" font-size="18" font-weight="bold">FYND</text></svg>` },

...
export function checkAdvancedCompliance(canvas: any, retailer: string = 'fynd'): ComplianceResult {
  const config = COMPLIANCE_RULES_DB[retailer as keyof typeof COMPLIANCE_RULES_DB] || COMPLIANCE_RULES_DB.fynd;

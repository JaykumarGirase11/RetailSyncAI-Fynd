...
const categories: Record<string, CategoryData> = {
  'food': {
    ...
    topBrands: ['Fynd Choice', 'McVities', 'Walkers', 'Cadbury', 'Kelloggs'],
    avgBasketSize: 45,
  ...
  'beverage': {
    ...
    topBrands: ['Coca-Cola', 'Fynd Own', 'Innocent', 'Costa', 'Red Bull'],
    avgBasketSize: 32,
  ...
  'personal_care': {
    ...
    topBrands: ['Dove', 'Nivea', 'LOreal', 'Fynd', 'Simple'],
    avgBasketSize: 28,
  ...
  'household': {
    ...
    topBrands: ['Fairy', 'Flash', 'Dettol', 'Persil', 'Fynd'],
    avgBasketSize: 35,
  ...
  'fresh': {
    ...
    topBrands: ['Fynd Premium', 'Organic', 'Local', 'Seasonal', 'Premium'],
    avgBasketSize: 42,
  ...
  'frozen': {
    ...
    topBrands: ['Birds Eye', 'McCain', 'Fynd', 'Iceland', 'Aunt Bessies'],
    avgBasketSize: 38,
  ...
  'dairy': {
    ...
    topBrands: ['Fynd', 'Arla', 'Cathedral City', 'Lurpak', 'Yeo Valley'],
    avgBasketSize: 25,
...
export const RetailDataAPI = {
  ...
  getPricingInsights(productName: string, basePrice: number): PricingInsight {
    ...
    return {
      ...
      recommendation: position === 'lowest' ? 
        ...
        'Emphasize Fynd Plus value' :
        'Focus on Fynd Premium quality',
  ...
  getPromotionAlerts(category: string): PromotionAlert[] {
    ...
    alerts.push({
      type: 'loyalty',
      title: 'Fynd Plus Prices Active',
      suggestion: 'Highlight Fynd Plus savings',
      endDate: 'Ongoing'
    });
  ...
  getCampaignBenchmarks(category: string) {
    ...
    return {
      ...
      topPerformers: {
        headline: 'Fynd Plus Price',
        cta: 'Shop Now',
        badgeType: 'fyndplus',
        colorScheme: 'fynd-primary'
      }
    };
  }
};
